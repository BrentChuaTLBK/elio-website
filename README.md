...
Automatic movement starts as soon as the carousel enters view, with no startup delay, and continues on hover. It pauses while swiping, while details are open, and when the carousel or page is out of view. It resumes automatically four seconds after manual navigation or focus interaction. Reduced-motion preferences disable automatic movement. Screen-reader status announcements are silent while it moves automatically; the full catalog page provides a stationary view of all flavors.
