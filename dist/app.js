(() => {
  ...
  const storyView = () => `<div class="dialog-body simple-dialog"><img class="story-logo" src="assets/elio-logo-original.png" width="110" height="110" alt="Elio by TLB Kitchen">${heading('Our story', 'A little about Elio.')}<p class="dialog-intro">Elio is Basque cheesecake by TLB Kitchen. Individual squares with deeply caramelized tops and soft centers, presented three to a box.</p><p class="dialog-intro">From classic Vanilla to earthy Matcha, the collection brings seven flavors to a little moment of indulgence.</p><a class="button" href="#flavors">Meet the collection</a></div>`;
